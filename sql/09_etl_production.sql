/* *** เลิกใช้แล้ว — ดู 25_remove_production_kpi.sql ***
   ไฟล์นี้เป็นของ KPI ฝั่งการผลิตซึ่งถูกถอดออกจากระบบแล้ว
   เก็บไว้เป็นประวัติของโครงการเท่านั้น ไม่ต้องรันบนฐานข้อมูลใหม่
   ถ้ารันจะสร้างตาราง/proc ที่ไม่มีใครใช้ขึ้นมาใหม่ */
